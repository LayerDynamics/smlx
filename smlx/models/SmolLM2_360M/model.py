...
This module implements SmolLM2-360M-Instruct, which uses the SmolLM3 architecture.
Despite the naming confusion, SmolLM2-360M models use the SmolLM3 architecture with
...
class ModelArgs(BaseModelArgs):
    """
    Model configuration for SmolLM2-360M (SmolLM3 architecture).
...
class Model(nn.Module):
    """
    SmolLM2-360M complete model (uses SmolLM3 architecture).
    ...
    - 360M parameters
    - 32 layers with selective RoPE (every 4th layer has no RoPE)
