...
"""
Configuration for SmolLM2-135M-Instruct model.
...
# Default configuration for SmolLM2-135M-Instruct
DEFAULT_CONFIG = {
    "model_type": "smollm",
...
def get_default_config() -> ModelArgs:
    """
    Get default configuration for SmolLM2-135M-Instruct.
...
def print_config(args: ModelArgs) -> None:
    ...
    utils_print_config(args, model_name="SmolLM2-135M")
