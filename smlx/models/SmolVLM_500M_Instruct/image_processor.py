...
class ImageProcessor:
    ...
    def preprocess(self, images: Union[Image.Image, List[Image.Image]]) -> List[np.ndarray]:
    ...
    def __call__(self, images: Union[Image.Image, List[Image.Image]], **kwargs) -> List[np.ndarray]:
