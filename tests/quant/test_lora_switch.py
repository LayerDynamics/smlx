...
class TestLoRASwitchLinear(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        layer = LoRASwitchLinear(input_dims=768, output_dims=3072, num_experts=8, r=16, scale=1.0)
    ...
    def test_forward_pass(self):
        ...
        # Switch layers route one expert per token, so the input carries an
        # explicit singleton "tokens-per-expert" axis: (num_tokens, 1, input).
        # This is the same shape SwitchGLU/SwitchMLP feed their SwitchLinears.
    ...
    def test_sorted_indices(self):
        ...
        layer = LoRASwitchLinear(input_dims=768, output_dims=3072, num_experts=8, r=16)
    ...
    def test_dropout(self):
        ...
        layer = LoRASwitchLinear(input_dims=768, output_dims=3072, num_experts=8, r=16, dropout=0.5)
    ...
    def test_trainable_parameters(self):
        ...
        # LoRA parameters should be trainable (tree_flatten lives in mlx.utils,
        # not mlx.core)
        from mlx.utils import tree_flatten

        trainable = tree_flatten(lora_layer.trainable_parameters())
...
class TestLoRASwitchIntegration(unittest.TestCase):
    ...
    def test_multi_expert_routing(self):
        ...
        layer = LoRASwitchLinear(input_dims=768, output_dims=768, num_experts=4, r=8, scale=1.0)
