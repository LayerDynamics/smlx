...
"""
SmolVLM-256M-Instruct Examples with Memory Best Practices
...
from smlx.models.SmolVLM_256M import load, generate, stream_generate, chat
...
def example_1_basic_image_description():
    ...
    # Load model
    print("Loading SmolVLM-256M model...")
...
def example_6_multi_image():
    ...
    print("SmolVLM-256M supports processing multiple images in a single prompt.")
    print()
...
def main():
    ...
    print()
    print("=" * 70)
    print("SmolVLM-256M-Instruct Examples")
    print("=" * 70)
    print()
    print("Vision-Language Model with:")
    print("- SigLIP-SO400M vision encoder")
    print("- SmolLM2-135M language model")
    print("- ~256M total parameters")
    print()
    ...
    try:
        ...
        print("2. Downloaded the SmolVLM-256M model")
